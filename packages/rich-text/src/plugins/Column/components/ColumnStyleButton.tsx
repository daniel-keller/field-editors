      ...
      <Menu.List>
        <Menu.Submenu>
          ...
          <Menu.List>
            ...
            <Menu.Item onClick={() => props.setStyle('text')}>None</Menu.Item>
          </Menu.List>
        </Menu.Submenu>
        <Menu.Submenu>
          <Menu.SubmenuTrigger>Vertical Aligment</Menu.SubmenuTrigger>
          <Menu.List>
            <Menu.Item onClick={() => props.setAlignItems('top')}>
            ...
            <Menu.Item onClick={() => props.setAlignItems('center')}>
            ...
            <Menu.Item onClick={() => props.setAlignItems('bottom')}>
